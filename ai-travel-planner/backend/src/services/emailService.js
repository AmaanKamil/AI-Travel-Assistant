...
exports.emailService = {
    send: function (to, attachmentPath) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    err_1 = _a.sent();
                    console.error('Email send failed:', err_1);
                    return [2 /*return*/, { success: false, message: err_1.message || 'Failed to send email.' }];
